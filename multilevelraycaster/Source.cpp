//pWallSprite = new olc::Sprite("bluestone.png");
//pFloorSprite = new olc::Sprite("wood.png");
//pCeilSprite = new olc::Sprite("wall_brd.png");
//std::string sSpritePath = "sprites/";
//pWallSprite = load_sprite_file("bluestone.png"); bSuccess &= (pWallSprite != nullptr);
//pFloorSprite = load_sprite_file("wood.png"); bSuccess &= (pFloorSprite != nullptr);
//pCeilSprite = load_sprite_file("wall_brd.png"); bSuccess &= (pCeilSprite != nullptr);
...
//Raycasting-tutorial-series---Permadi-inspired/main - part 22c (working version, bugs in roof ceil texturing).cpp
...
public:
    ...
    bool OnUserCreate() override {
        ...
        pWallSprite = load_sprite_file("new wall_brd.png"); bSuccess &= (pWallSprite != nullptr);
        pFloorSprite = load_sprite_file("grass_texture.png"); bSuccess &= (pFloorSprite != nullptr);
        pCeilSprite = load_sprite_file("bluestone.png"); bSuccess &= (pCeilSprite != nullptr);
        pRoofSprite = load_sprite_file("wood.png"); bSuccess &= (pRoofSprite != nullptr);

        // load sprites for rendering objects
        std::string sSpritePath2 = "sprites/";
        pObjectSprite[0] = load_sprite_file("elf-girl_stationary-front.rbg.png"); bSuccess &= (pObjectSprite != nullptr);   // elf girl

        pObjectSprite[1] = load_sprite_file("bush_object_01.rbg.png"); bSuccess &= (pObjectSprite != nullptr);   // bushes
        pObjectSprite[2] = load_sprite_file("bush_object_02.rbg.png"); bSuccess &= (pObjectSprite != nullptr);
        pObjectSprite[3] = load_sprite_file("bush_object_03.rbg.png"); bSuccess &= (pObjectSprite != nullptr);
        pObjectSprite[4] = load_sprite_file("bush_object_04.rbg.png"); bSuccess &= (pObjectSprite != nullptr);
           ...
           for(int i = 0; i < vHitPointList.size(); i++)
            {
                ...
                if (hitRec.fHeight > 0.0f) {
                    ...
                    if (i == 0)
                    {
                        IntersectInfo& temprec = vHitPointList[i];
                        if (x == ScreenWidth() / 2)
                        {
                            DrawLine(x, temprec.top_front, x, temprec.top_back, olc::YELLOW);
                            DrawLine(x, temprec.bot_front, x, temprec.bot_back, olc::YELLOW);
                            DrawString(10, 30, "hitpointlistsize: " + std::to_string(vHitPointList.size()), olc::BLACK);
